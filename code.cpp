...
//se o led está ligado ou desligado. Adicionado leitura de sensor DHT para temperatura e umidade.
//Revisões:
...
const char* default_TOPICO_SUBSCRIBE = "/TEF/device003/cmd"; // Tópico MQTT de escuta
const char* default_TOPICO_PUBLISH_1 = "/TEF/device003/attrs"; // Tópico MQTT de envio de informações para Broker
const char* default_TOPICO_PUBLISH_2 = "/TEF/device003/attrs/p"; // Tópico MQTT de envio de informações para Broker
const char* default_TOPICO_PUBLISH_DHT = "/TEF/device003/attrs/dht"; // Tópico MQTT de envio de informações do DHT
...
#define DHTTYPE DHT11    // Pode ser DHT11, DHT22, etc.
 
DHT dht(DHTPIN, DHTTYPE);
 
// Declaração da variável para o prefixo do tópico
const char* topicPrefix = "device003";
